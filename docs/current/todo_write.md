...
[
  ...
  { "content": "T2.1 /src/assets/css/tokens.css(CSS变量:颜色#0072CE/#F8F9FA/CTA#F5821F、字体Inter+Roboto、间距/圆角8-12px/阴影/层级/断点,逐字对齐design§2) — 完成标准：变量齐全且色值/字体符合G5/G6", "status": "in_progress" },
