...
| `advantageNote` | String | Required | Short (1–2 sentence) distributor-advantage blurb for the "优势对比" feature card (design §5.3 feature-card row) | `{{category.advantageNote}}` in the Advantages feature card |
